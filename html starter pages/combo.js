...
function makeRow(summary) {
    ...
    for (var i = 0; i < summary.length; i++) {
        ...
        var td = document.createElement("td");
        td.innerHTML = Math.round(summary[i].votes_with_party_pct);
        tr.appendChild(td);
...
function makeRowAttendance(membersArray) {
    ...
    for (var i = 0; i < membersArray.length; i++) {
        ...
        var td = document.createElement("td");
        td.innerHTML = Math.round(membersArray[i].missed_votes_pct);
        tr.appendChild(td);
...
function makeRowAttendance2(membersArray) {
    ...
    for (var i = 0; i < membersArray.length; i++) {
        ...
        var td = document.createElement("td");
        td.innerHTML = membersArray[i].missed_votes_pct.toFixed(2);
        tr.appendChild(td);
